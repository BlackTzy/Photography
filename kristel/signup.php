...
<body background="background.gif" style="background-size:cover;">
<body background="background.gif">
    <div id="box" class="login-box">
        ...
        <form method="post" class="user-box">
            ...
            <label style="transform: translateY(90px);">Password</label>
            <br><br>

            <input class="btn" id="button" type="submit" value="Signup"><br><br>

            <a href="login.php" style="transform: translateX(24%);">Click to Login</a><br><br>
